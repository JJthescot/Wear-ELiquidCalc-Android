...
public class MixDetails_Activity extends WearableActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_Header = (TextView) findViewById(R.id.mix_header_textview);
        textView_Header.setText(passedRecipe.getName());

        textView_Quantity = (TextView) findViewById(R.id.mix_amount_textview);
        textView_Result = (TextView) findViewById(R.id.mix_results_textview);
        seekBar_Quantity = (SeekBar) findViewById(R.id.mix_seekBar_amount);
