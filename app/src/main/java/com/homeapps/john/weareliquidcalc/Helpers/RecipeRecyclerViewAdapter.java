...
public class RecipeRecyclerViewAdapter extends RecyclerView.Adapter<RecipeRecyclerViewAdapter.myViewHolder> {
    ...
    public static class myViewHolder extends RecyclerView.ViewHolder {
        ...
        public myViewHolder(@NonNull View itemView) {
            super(itemView);
            mTextView_Row1 = (TextView) itemView.findViewById(R.id.recipe_textview_row1);//itemView;
            mTextView_Row2 = (TextView) itemView.findViewById(R.id.recipe_textview_row2);//itemView;
        }
    }
    ...
    public RecipeRecyclerViewAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = (View) LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.recycler_view_item,viewGroup,false);
